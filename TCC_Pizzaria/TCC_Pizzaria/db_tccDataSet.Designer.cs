...
namespace TCC_Pizzaria.db_tccDataSetTableAdapters {
...
SELECT id, nome, usuario, senha, perfil FROM tb_usuario WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=SNCTP07LABF17\\SQLEXPRESS;Initial Catalog=db_tcc;Integrated Security=T" +
                "rue";
        }
        ...
        public virtual int Fill(db_tccDataSet.tb_usuarioDataTable dataTable) {
        ...
        public virtual db_tccDataSet.tb_usuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            db_tccDataSet.tb_usuarioDataTable dataTable = new db_tccDataSet.tb_usuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(db_tccDataSet.tb_usuarioDataTable dataTable) {
